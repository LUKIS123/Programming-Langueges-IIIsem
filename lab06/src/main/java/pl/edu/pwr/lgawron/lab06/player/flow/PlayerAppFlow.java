...
public class PlayerAppFlow {
    ...
    public PlayerAppFlow() {
        ...
        this.serverResponseQueue = new ServerResponseQueue();
    }
    ...
    public void startRegistration(ValuesHolder valuesHolder, VBox controls, GridPane mapPane, GridPane playerPane) {
        ...
        this.receiverSocket = new PlayerReceiverSocket(valuesHolder.getPort(), valuesHolder.getServer(), senderSocket, serverResponseQueue);
    ...
    public void startAlgo() {
        ...
        executor = new PlayerAIAlgorithm(playerClientService, serverResponseQueue, receiverSocket);
        executor.start();
    }
    ...
    public void startManualExecutor() {
        ...
        executor = new ManualTaskExecutor(playerClientService, receiverSocket, serverResponseQueue);
        executor.start();
    }
